...
rUpdatePlantNitrogen <-function(){
  ...
  if(TRUE){ # if (any(crop_presence))
    ...
    pSNCG <- ALLDAYDATA$pSNCG # to get pSNCG #### ICICIC NUULLLL
    ...
    ## Listing of variables needed in the procedure to compute cumulative variables
    ...
    sAccumulatedNGrain <- ALLDAYDATA$sAccumulatedNGrain # to get NGRN
    sTotalAccumulatedNitrogen <- ALLDAYDATA$sTotalAccumulatedNitrogen # to get NVEG
    ...
    resultat1 <- matrix(nrow=NCASE, ncol=6)
